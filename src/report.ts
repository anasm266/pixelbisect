...
.grid{display:grid;grid-template-columns:1.2fr .8fr;gap:18px}.grid>.card{display:flex;flex-direction:column}.grid>.card .card-body{flex:1}.grid>.card:first-child .card-body{display:grid;place-items:center}.diff-image{display:block;max-width:100%;max-height:520px;margin:auto;border-radius:12px;background:#fff}.facts{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:1px;background:var(--line);border:1px solid var(--line);border-radius:12px;overflow:hidden}.fact{background:var(--panel);padding:13px 15px;min-width:0}.fact dt{color:var(--muted);font-size:11px;text-transform:uppercase;letter-spacing:.08em}.fact dd{margin:3px 0 0;overflow-wrap:anywhere}.commit{display:flex;gap:13px;align-items:flex-start;padding:15px;border:1px solid var(--line);border-radius:12px;background:#0b1220}.commit+.commit{margin-top:10px}.dot{width:10px;height:10px;border-radius:50%;margin-top:7px;flex:none;background:var(--red);box-shadow:0 0 18px currentColor}.commit.good .dot{background:var(--green)}.commit code,.hash{color:var(--cyan);font-family:ui-monospace,SFMono-Regular,Consolas,monospace}.commit strong{display:block}.commit small{display:block;color:var(--muted);margin-top:3px}.meta{margin-top:14px;color:var(--muted);font-size:13px}.warning{border-left:3px solid #f59e0b;padding:12px 15px;background:#f59e0b10;color:#fcd34d;border-radius:0 9px 9px 0}
